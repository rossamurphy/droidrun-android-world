"""
Keycode to name mapping for Android KeyEvent.
This mapping is used to convert numeric keycodes to their corresponding enum names
for use with the AndroidEnvClient.
"""
...
def get_keycode_name(keycode: int) -> str:
    """
    Convert a numeric keycode to its corresponding enum name.
    
    Args:
        keycode: The numeric keycode to convert
        
    Returns:
        The corresponding enum name if found, otherwise "KEYCODE_UNKNOWN"
    """
    return KEYCODE_MAP.get(keycode, "KEYCODE_UNKNOWN") 